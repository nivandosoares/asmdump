...
- capture or statically tie the unresolved bottom-right `$1C70 = 3` slot to a
  named asset/text source before spending more time on fresh callback forcing.
