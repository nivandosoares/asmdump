...
- Remaining user-guided heuristic:
  ...
  - the remaining proving target is now post-handoff divergence:
    capture the first no-opponent `02:9016` window and compare it against the
    default-rival baseline, instead of spending more runs on front-end
    confirmation
