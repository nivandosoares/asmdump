...
- Remaining user-guided heuristic:
  ...
  - `L00C20B` itself is now structurally closed:
    - selector field `$1C70`
    - domain `0..3`
  ...
  - the remaining proving target is no longer the grid geometry; it is whether
    the unresolved fourth cell is the time-only/clock slot from the guided
    flow
