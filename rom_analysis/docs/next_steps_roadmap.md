...
- Remaining user-guided heuristic:
  ...
  - the remaining proving target is no longer “what is the fourth slot?” or
    “does it affect handoff?”;
    it is where the `$1C76 = 0` and `$1C76 = 1` paths diverge organically in
    live runtime/HUD/callback behavior
