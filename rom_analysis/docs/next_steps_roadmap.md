...
- Remaining user-guided heuristic:
  ...
  - the remaining proving target is no longer “what is the fourth slot?”;
    it is the later gameplay-handoff semantics after choosing that clock slot
