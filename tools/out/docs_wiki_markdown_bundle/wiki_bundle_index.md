...
- `sources/rom_analysis/README.md` | source `rom_analysis/README.md` | updated `2026-03-06 20:05`
  note: Top-level archaeology tree orientation.

### Compression And Bank30

- `sources/rom_analysis/docs/bank30_decompression_report.md` | source `rom_analysis/docs/bank30_decompression_report.md` | updated `2026-03-21 11:59`
  note: Current registry-backed read of bank30 markers and the active unresolved queue.
- `sources/rom_analysis/docs/bank30_b1f9_forced_lane_stall.md` | source `rom_analysis/docs/bank30_b1f9_forced_lane_stall.md` | updated `2026-03-28 11:18`
  note: Why the current headless `B1F9` forcing lane is low-yield for `EE7F`.

### Attract And Intro

- `sources/rom_analysis/docs/intro_00_8029_next_agent_handoff.md` | source `rom_analysis/docs/intro_00_8029_next_agent_handoff.md` | updated `2026-03-28 08:52`
  note: Active handoff for the later attract continuation lane.
- `sources/rom_analysis/docs/intro_01_9fe5_window_986_1093.md` | source `rom_analysis/docs/intro_01_9fe5_window_986_1093.md` | updated `2026-03-22 10:25`
  note: Consolidated visual-contract note for the bridge-visible intro block.
- `sources/rom_analysis/docs/intro_01_9fe5_activity_trace_1094_1117.md` | source `rom_analysis/docs/intro_01_9fe5_activity_trace_1094_1117.md` | updated `2026-03-22 11:47`
  note: Producer-side activity narrowing for the post-1093 window.
- `sources/rom_analysis/docs/intro_00_8029_mode7_blob_cycle_1134_1200.md` | source `rom_analysis/docs/intro_00_8029_mode7_blob_cycle_1134_1200.md` | updated `2026-03-28 08:52`
  note: Late 00:8029 blob rotation report and selector narrowing.
- `sources/rom_analysis/maps/tilemaps/mesen_range_1086_1093_provenance.md` | source `rom_analysis/maps/tilemaps/mesen_range_1086_1093_provenance.md` | updated `2026-03-07 13:14`
...
- `sources/rom_analysis/docs/snes_runtime_algorithm_human.md` | source `rom_analysis/docs/snes_runtime_algorithm_human.md` | updated `2026-03-27 22:02`
  note: Human-readable interpretation of the front-end and handoff corridor.
- `sources/rom_analysis/maps/tilemaps/car_select_frame_1500_bg2_provenance.md` | source `rom_analysis/maps/tilemaps/car_select_frame_1500_bg2_provenance.md` | updated `2026-03-26 22:04`
  note: Car-presentation BG2 ownership without treating it as gameplay.
- `sources/tools/out/snes_frontend_top_menu_labels.md` | source `tools/out/snes_frontend_top_menu_labels.md` | updated `2026-03-27 10:07`
  note: Closed rendered label set for the top signboard menu.
- `sources/tools/out/snes_frontend_rival_selection_grid.md` | source `tools/out/snes_frontend_rival_selection_grid.md` | updated `2026-03-27 11:57`
  note: Rendered and structural read of the 2x2 opponent grid.
- `sources/tools/out/snes_select_opponent_organic_default_path.md` | source `tools/out/snes_select_opponent_organic_default_path.md` | updated `2026-03-27 12:21`
  note: Recovered no-force path into the default rival corridor.
- `sources/tools/out/snes_frontend_select_opponent_mode_split.md` | source `tools/out/snes_frontend_select_opponent_mode_split.md` | updated `2026-03-27 11:57`
...
- `sources/rom_analysis/maps/tracks/track1_live_gameplay_entry_route.md` | source `rom_analysis/maps/tracks/track1_live_gameplay_entry_route.md` | updated `2026-03-28 09:50`
  note: Promoted power-on route for reproducible gameplay entry.
- `sources/rom_analysis/maps/tracks/track1_live_entry_phase_split_3250_3550.md` | source `rom_analysis/maps/tracks/track1_live_entry_phase_split_3250_3550.md` | updated `2026-03-28 13:42`
  note: First promoted late gameplay pair from the live-entry route, with stable artifact bundles for both phases.
- `sources/rom_analysis/maps/tracks/track1_live_entry_brake_traffic_pair_3250_3400.md` | source `rom_analysis/maps/tracks/track1_live_entry_brake_traffic_pair_3250_3400.md` | updated `2026-03-28 13:42`
  note: Bounded live-entry follow-up that isolates traffic emergence as a cleaner OBJ-side event.
- `sources/rom_analysis/maps/tracks/track1_live_race_asset_focus.md` | source `rom_analysis/maps/tracks/track1_live_race_asset_focus.md` | updated `2026-03-28 11:36`
  note: Asset-first gameplay taxonomy that maps BG/OBJ buckets to tracing targets.
- `sources/rom_analysis/maps/tracks/track1_live_race_native_visible_layers.md` | source `rom_analysis/maps/tracks/track1_live_race_native_visible_layers.md` | updated `2026-03-28 14:45`
  note: Savestate-backed gameplay extraction that now closes native `BG2` road and `BG3` scenery surfaces.
- `sources/tools/out/lane3_live_entry_frame03250_vs_03550_compare.md` | source `tools/out/lane3_live_entry_frame03250_vs_03550_compare.md` | updated `2026-03-28 13:40`
  note: Generated BG1/BG2/OBJ compare for the first late live-entry gameplay pair.
- `sources/tools/out/lane3_live_entry_brake_traffic_3250_vs_3400_compare.md` | source `tools/out/lane3_live_entry_brake_traffic_3250_vs_3400_compare.md` | updated `2026-03-28 13:40`
  note: Generated compare showing the red traffic car as the current best OBJ-side live-entry event.
- `sources/tools/out/lane3_live_race_mid_asset_focus.md` | source `tools/out/lane3_live_race_mid_asset_focus.md` | updated `2026-03-28 11:42`
  note: Generated gameplay inventory with supporting frame/layer artifact references.
- `sources/rom_analysis/maps/tracks/track1_live_race_manual_seed_intake.md` | source `rom_analysis/maps/tracks/track1_live_race_manual_seed_intake.md` | updated `2026-03-28 09:05`
...
- `sources/rom_analysis/maps/tracks/track1_02_9016_state_ownership.md` | source `rom_analysis/maps/tracks/track1_02_9016_state_ownership.md` | updated `2026-03-27 22:59`
  note: Semantic ownership pass for post-handoff gameplay fields.

### Runtime And Port Validation

- `sources/rom_analysis/docs/port_sdl_runtime_mimetization_smoke.md` | source `rom_analysis/docs/port_sdl_runtime_mimetization_smoke.md` | updated `2026-03-28 10:19`
  note: Bounded regression read for current intro/front-end parity in the C/SDL runtime.
- `sources/rom_analysis/docs/mesen_instrumented_backend_architecture.md` | source `rom_analysis/docs/mesen_instrumented_backend_architecture.md` | updated `2026-03-22 22:03`
