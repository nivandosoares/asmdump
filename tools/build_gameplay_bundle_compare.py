...
def load_bundle_summary(bundle_dir: Path) -> dict:
    ...
    return {
        ...
        "bg_stack_visible_support_png": outputs.get("bg_stack_visible_support_png"),
        "world_visible_support_png": outputs.get("world_visible_support_png"),
...
def build_markdown(report: dict) -> str:
    ...
    lines = [
        ...
        "## Visual Anchors",
        "",
        f"- `{label_a}` screenshot-derived background stack support: `{a['bg_stack_visible_support_png']}`",
        f"- `{label_a}` screenshot-derived world support: `{a['world_visible_support_png']}`",
        f"- `{label_a}` `BG1`: `{a['bg1_png'] or a['bg1_ppm']}`",
        f"- `{label_a}` `BG2`: `{a['bg2_png'] or a['bg2_ppm']}`",
        f"- `{label_a}` `OBJ`: `{a['obj_png'] or a['obj_ppm']}`",
        f"- `{label_b}` screenshot-derived background stack support: `{b['bg_stack_visible_support_png']}`",
        f"- `{label_b}` screenshot-derived world support: `{b['world_visible_support_png']}`",
